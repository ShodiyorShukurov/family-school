	...
	return (
		<section className='relative min-h-screen'>
			...
			<div className='container flex flex-col-reverse md:flex-row min-h-screen md:justify-between items-center pt-6 w-full'>
				<div>
					<h1 className='text-[40px] md:text-[72px] leading-[100%] bg-gradient-to-b from-[#FEF5C9] to-[#D5AB65] bg-clip-text text-transparent w-full md:max-w-[500px]'>
					...
					<button
						...
						className=' relative cursor-pointer w-full md:max-w-[400px] mt-16'
					>
						<img
						...
						<span
							...
							className='w-full pl-[40px] text-[#403211] md:text-[24px] py-4 rounded-[6px] manrope-bold cursor-pointer block'
						>
							RO’YXATDAN O’TISH
						</span>
					</button>
